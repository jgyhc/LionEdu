...
/**
 * 水平 标签间距,和距离左，上间距,默认10
 */
@property (nonatomic, assign) CGFloat horizontalTagMargin;

/**
 * 垂直 标签间距,和距离左，上间距,默认10
 */
@property (nonatomic, assign) CGFloat verticalTagMargin;
 ...
 *  点击标签，执行Block
 */
@property (nonatomic, strong) void(^clickTagBlock)(UIButton *button, NSString *tag);
