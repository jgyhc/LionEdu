...
/** 滑块的大小 */
#define kSliderBtnW 64.0

#define kSliderBtnH 18
/** 间距 */
...
- (void)setButtonTitle:(NSString *)buttonTitle {
    ...
    [self.sliderBtn setTitle:buttonTitle forState:UIControlStateNormal];
}
...
- (void)addSubViews {
    ...
    self.sliderBtn.frame          = CGRectMake(0, 0, kSliderBtnW, kSliderBtnH);
...
//        _sliderBtn.backgroundColor = [UIColor whiteColor];
        ...
        _sliderBtn.titleLabel.font = [UIFont systemFontOfSize:10];
        [_sliderBtn setBackgroundColor:[UIColor colorWithRed:64/255.0 green:64/255.0 blue:64/255.0 alpha:1.0]];
        _sliderBtn.layer.cornerRadius = 9;
