...
- (void)xwp_gestureChange:(UILongPressGestureRecognizer *)longPressGesture{
    ...
    if ([self.delegate respondsToSelector:@selector(dragCellCollectionViewCellisMoving:orLocation:)]) {
        [self.delegate dragCellCollectionViewCellisMoving:self orLocation:_tempMoveCell.center];
    }
