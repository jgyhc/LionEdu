...
#import "BLMyClassViewController.h"
...
@interface BLMyClassViewController ()<JXCategoryViewDelegate, JXCategoryListContainerViewDelegate>
...
@implementation BLMyClassViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.titles = @[@"直播", @"录播", @"面试"];
...
- (id<JXCategoryListContentViewDelegate>)preferredListAtIndex:(NSInteger)index {
    BLMyClassTableViewController *vc =  [[UIStoryboard storyboardWithName:@"My" bundle:[NSBundle mainBundle]] instantiateViewControllerWithIdentifier:@"BLMyClassTableViewController"];
    vc.classType = index;
    return vc;
}
