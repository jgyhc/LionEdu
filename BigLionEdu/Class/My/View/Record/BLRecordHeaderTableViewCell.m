...
#import "BLRecordHeaderTableViewCell.h"

@interface BLRecordHeaderTableViewCell ()
...
@implementation BLRecordHeaderTableViewCell
...
- (void)setModel:(BLMyRecordInfoModel *)model {
    ...
    _model = model;
    _numLabel.text = [NSString stringWithFormat:@"%ld套",(long)model.questionNum];
